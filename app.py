...
# 创建一个常驻占位符，用来刷新整个页面的内容
main_placeholder = st.empty()

# =================================================================
# 【核心升级】利用无线循环+每2秒睡眠，实现服务器端主动推流刷新
# =================================================================
while True:
    df, current_price, is_live = get_market_data_gate()
    ...
    # 强制让程序休眠 2 秒后进入下一个大循环，从而让行权价、倒计时实现每 2 秒完全自主跳动！
    time.sleep(2)
